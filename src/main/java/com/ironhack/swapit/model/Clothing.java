...
public class Clothing extends Item {
    ...
    // Custom Constructors
    public Clothing(String title, User owner, ClothingCategory category, ClothingType type, String size) {
        super(title, owner);
    ...
    public Clothing(String title, String description, User owner, ClothingCategory category, ClothingType type, String size) {
